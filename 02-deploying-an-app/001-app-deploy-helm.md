...
It is assumed you have the following:
 ...
 - You have [created an environment for your application]({{ site.baseurl }}/cloud-platform/env-create)
 - You have installed [Kubectl](https://kubernetes.io/docs/tasks/tools/install-kubectl/) on your local machine.
 - You have [Authenticated]({{ site.baseurl }}/cloud-platform/authenticate) to the cluster known as the 'non-production' cluster.
