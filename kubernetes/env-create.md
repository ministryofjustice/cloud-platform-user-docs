...
This Rolebinding resource references the ClusterRole to provide ClusterRole admin access to a set of users which is defined under subjects. In this case, the $yourTeam github group will have admin access to any resources within the namesapce "myapp dev".
